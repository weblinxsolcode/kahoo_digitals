        ...
        <div className="container my-5 pl-0  p-0">
          <div className="row mx-0  pl-0">
            <div className="col-lg-5 text-white ak-f-2">
              ...
              <p className="ak_contact_con_text2">Let's make something new, different and more meaningful
or make thing more visual or conceptual?</p>
              <div className="row mx-0 my-5 ak_contact_content2">
                <div className="col-lg-1  text-end my-1 p-0">
                  <img className="img-fluid ak_location_icon" src={ak_locationicon} alt="" />


                </div>
                <div className="col-lg-6">
                  <p className=""> <span className="ak_contact_span">SINGAPORE OFFICE</span> <br />
                    Virtuse Group <br />
              ...
              <div className="row mx-0 my-5 ak_contact_content2">
                ...
                <div className="col-lg-6">
                  <p className=""> <span className="ak_contact_span">EUROPEAN OFFICE</span> <br />
            ...
            <div className="col-lg-7 text-white ak-f-1">
              ...
              <form id="contact-form" name="contact-form" action="mail.php" method="POST">
                ...
                <div class="row mx-0 my-5 ak_form_hight">
                  ...
                  <div class="col-md-6 my-3 ak_form_hight">
                    <div class="md-form mb-0">
                      <input placeholder="First Name" type="text" id="name" name="name" class="form-control" />
                    </div>
                  </div>
                  ...
                  <div class="col-md-6 my-3 ak_form_hight">
                    <div class="md-form mb-0">
                      <input placeholder="Last name" type="text" id="email" name="email" class="form-control" />
                    </div>
                  </div>
                ...
                <div class="row my-5   mx-0 ak_form_hight">
                  <div class="col-md-12">
                    <div class="md-form mb-0">
                      <input placeholder="Email" type="text" id="subject" name="subject" class="form-control" />
                    </div>
                  </div>
                </div>
                ...
                <div class="row mx-0 my-5 ">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="md-form">
                      <textarea placeholder="Enything else we should know? (Optional)" type="text" id="message" name="message" rows="5" class="form-control md-textarea"></textarea>
                    </div>
