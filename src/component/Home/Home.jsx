...
import ak_play_store from '../../assests/images/ak_play_store.png'
import ak_app_store from '../../assests/images/ak_app_store.png'
  ...
  return (
    <div className="App">
      ...
      <section className="ak_contact_section">
        <div className="container-fluid  ak_contactbanner4">
          <div className="d-flex flex-column ak_home_icons">
            <a href="">
              {" "}
          ...
          <div className="container">
            <div className="row mx-0 justify-content-center align-items-center">
              <div className="col-lg-6">
                <h1 className="text-white fw-bolder  ak_header_h">
                  A one-stop shop for your Bitcoin
                </h1>
                <p className="text-white  ak_header_p">
                  Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed
                  diam nonumy eirmod tempor invidunt ut.
                </p>

                <div className=" ak_banner_button  ">
                  <button className="buy_btn">
                    <a href="">
                      Buy Bitcoin<i class="fas fa-angle-right"></i>
                    </a>
                  </button>
                  <button className="watch_btn">
                    <a href="">
                      Watch Videos <i class="fas fa-long-arrow-right"></i>
                    </a>
                  </button>
                </div>
              </div>
              <div className="col-lg-6">
                <img className="img-fluid" src={ak_homeimage1} alt="" />
              </div>
            </div>
          </div>
        </div>
      ...
      {/* only bitcoin */}
      <section className="home_only_bit_parent my-5 ak_home_bitcoin ">
        ...
        <div className="bitcoin_cards">
          <div
            className="al_card border-primary mb-3"
            style={{ maxWidth: "18rem" }}
          >
            {/* <div className="card-header">Header</div> */}
            <div className="card-body text-white text-start my-4">
      ...
      {/* news */}
      <section className="Virtuse_news ak_home_vituse">
      ...
      <section className="ak_automated_bg_banner">
        <div className="Automated ">
          ...
          <div className="automated_content col-12 col-md-7 col-lg-7">
            <p className="automated_head">Automated Investing</p>
            <p className="automated_para">
              Dollar-Cost Averaging is by far the smartest way to accumulate
              wealth. You can purchase automatically using Virtuse's recurring
              orders. Choose between daily, weekly, or monthly investments.
            </p>
            <div className="automated_bullet">
              <div className="bullet_border"></div>
              <div className="bullet_content">
                Harness the power “the eighth wonder of the world.”
              </div>
            </div>
            <div className="automated_bullet">
              <div className="bullet_border"></div>
              <div className="bullet_content">
                Set aside money to buy Bitcoin automatically
              </div>
            </div>
            <div className="automated_bullet">
              <div className="bullet_border"></div>
            ...
            <div className="automated_bullet mb-4">
              <div className="bullet_border"></div>
              <div className="bullet_content">
                Dollar-Cost Averaging strategy beats 95% of institutional money
                managers.
              </div>
            </div>
            <p>
      ...
      {/* getting started */}
      <section className="ak_get_started_banner">
        <div className="container get_started">
          <div className="started_content col-12 col-md-8 col-lg-8">
            <p className="started_head">Get started in 3 minutes</p>
            ...
            <div className="start_automated_bullet">
              ...
              <div className="bullet_content">
                ...
                Add a deposit to your account using a credit card, bank
            ...
            <div className="start_automated_bullet">
              ...
              <div className="bullet_content">
                ...
                Make instant purchases or set up an automated investment. It's
                that easy!
              </div>
            </div>
          </div>
      ...
      <section>
        <div className="as_seen">
          <div className="container">
            ...
            <div className="row mx-0 my-5 p-0 ak_home_seen2">
        ...
        <div className="container-fluid   p-0 my-5">
          <div className="row mx-0 ">
            <h3 className="text-white text-center">
              Virtuse is available in 100+ countries
            </h3>
            <div className="col-lg-12 ak_devices_bg ">
              <div className="container ak_home_stores">
                <div className="row mx-0 justify-content-center  align-items-center ak_store_11">
                  <h4 className="text-white my-5    text-center fw-bold">
                    Download App
                  </h4>

                  <div className="col-lg-6 d-flex justify-content-end align-items-center ak_store_phone">
                    <a href="">
                      {" "}
                      <img className="img-fluid" src={ak_play_store} alt="" />
                    </a>
                  </div>
                  <div className="col-lg-6 my-5 d-flex justify-content-start align-items-center ak_store_phone">
                    <a href="">
                      {" "}
                      <img className="img-fluid" src={ak_app_store} alt="" />
                    </a>
                  </div>
                </div>
              </div>
