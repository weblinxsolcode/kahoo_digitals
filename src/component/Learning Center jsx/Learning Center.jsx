  ...
  return (
    <div className="App">
        ...
        <nav class="navbar navbar-expand-lg ">
          <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <form class="d-flex justify-content-center align-items-centery">
      ...
      <section className="ak_learning_content">
        <div className="container">
          <div className="row mx-0">
            <div className="col-lg-12 text-center my-5">
              ...
              <p className="ak_text-custom2">
                Weekly letter to over 15,000 investors about business,
          ...
          <div className="container">
            <div className="row mx-0 ak_learning_bg_cards justify-content-center">
              <div className="col-lg-4">
                <div className="card">
                  ...
                  <p>
                    Ignore the Bearish Noise and Invest in Technologies and
                    Bitcoin
                  </p>
                  <a className="p-3" href="">
                    Learn more <i class="fas fa-long-arrow-right"></i>
                  </a>
                </div>
              </div>
              <div className="col-lg-4">
              ...
              <div className="col-lg-4">
                <div className="card">
                  ...
                  <h6>26th October,2019</h6>
                  <p>5 Reasons Why You Should Own Bitcoin in 2022</p>
                  <a className="p-4" href="">
                    Learn more <i class="fas fa-long-arrow-right"></i>
                  </a>
                </div>
            ...
            <div className="row mx-0 ak_learning_bg_cards justify-content-center">
              ...
              <div className="col-lg-4">
                <div className="card">
                  <img
                    className="img-fluid ak_learn_img"
                    src={ak_learning3}
                    alt=""
                  />
                  <h6>26th October,2019</h6>
        ...
        <section className="ak_contactus_2 pt-5">
              ...
              <div class="row mt-3">
                <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                  ...
                  <p className="text-white">
                    subscribe to{" "}
                    <span className="fw-bolder border-bottom"> virtuse</span>{" "}
                    our monthly look
                  </p>
