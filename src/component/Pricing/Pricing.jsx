        ...
        <div className="container-fluid ak_pricingbg ">
         ...
         <div className="row mx-0 justify-content-center align-items-center pt-5 ">
            <div className="col-lg-12 text-center">
              <img src={ak_line} alt="" />
              <h4 className="text-white pt-3">Bitcoin accessible to everyone</h4>
              <p className="ak_pricing_text1">Virtuse Premium and Wealth services help you supercharge your Bitcoin accumulation.</p>

            </div>
          </div>
          <div className="row mx-0 justify-content-center align-items-center">
            <div className="col-lg-6 d-flex justify-content-center align-items-center text-center pt-5">
            <div class="card ak_pricing_premium">
                <div class="card-body">
                  ...
                  <p class="card-text ak_premium_text4">With Virtuse Premium enjoy this suite of features and benefits.</p>
                  ...
                  <div className="pt-4">
                  <h6 className="ak_premium_text6">VEX Basic and VEX Pro platforms</h6>
                ...
                <div className="pt-5 pb-4">
                  <button className="btn btn_pricing1"><a href="">START INVESTING</a></button>
                </div>
              </div>
            </div>
            <div className="col-lg-6 text-center pt-5 d-flex justify-content-center align-items-center  ">
            <div class="card ak_pricing_premium2">
                <div class="card-body">
                  <h4 class="card-title ak_premium_text1">Virtuse Wealth</h4>
                  {/* <h6 class="card-subtitle mb-2 ak_premium_text2">0.15%</h6> */}
                  <h3 className="ak_premium_text3">performancefee</h3>
                  <h3 className="ak_premium_text3_1">fee</h3>
                  <p class="card-text ak_premium_text4">Virtuse Wealth helps clients with over 0.5 Bitcoin in AuM to actively manage their digital assets.</p>
                  <div className="d-flex justify-content-center ">
                  <div className="border-bottom1 "></div>
                  ...
                  <h6 className="ak_premium_text7">VEX Basic and VEX Pro platforms</h6>
                ...
                <div className="pt-5 pb-4">
                  <button className="btn btn_pricing2"><a href="">SCHEDULE A CALL</a></button>
                </div>
              </div>
            </div>
...
<section className="ak_pricing_table">
  ...
  <tbody className="ak_table_p">
    ...
    <tr className="ak_tr1">
      <th className="ak_tr2" scope="row">Lorem ipsum</th>
      <td>Lorem ipsum</td>
      <td>Lorem ipsum</td>
    </tr>
    <tr>
